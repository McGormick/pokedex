...
async function loadPokemon(id) {
    ...
    if (currentPokemonId === id) {
        ...
        window.history.pushState({}, "", `./detail.html?id=${id}`); //Mahdollistaa sivun tietojen päivittämisen ilman itse koko sivun päivittämistä
    }
...
const typeColors = { //TAUSTAVÄRIT ERI TYYPEILLE
    normal: "#A8A878",
    fire: "#F08030",
    water: "#6890F0",
    electric: "#F8D030",
...
function rgbaFromHex(hexColor) {//Saadaan translucent väriefekti aikases stats rivillä
    return [
...
function displayPokemonDetails(pokemon) {
    ...
    const detailMainElement = document.querySelector
    (".detail-main");
